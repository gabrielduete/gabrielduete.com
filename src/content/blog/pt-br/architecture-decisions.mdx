...
<i>
  Este post segue o formato de Architecture Decision Records (ADRs) para
  documentar decisões arquiteturais importantes. Para mais informações sobre
  ADRs, consulte a [documentação oficial](https://adr.github.io/).
</i>
